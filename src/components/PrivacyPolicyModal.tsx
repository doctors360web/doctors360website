      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-sm text-slate-brand leading-relaxed">
          <div>
            ...
            <p>This Privacy Policy describes how Doctors360 Medical Centre collects, uses, stores, shares, and protects personal information when providing healthcare services and operating its website.</p>
          </div>
